...
make cleanup   # common stale host-mount cleanup
...
`make cleanup` runs the stale loop/NBD mount cleanup path for interrupted disk
builds. `make phases` prints the numbered flow.
